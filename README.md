...
let hook = DurableEvidenceHook::new(
    DurableConfig::from_env(),   // 32 MiB per body, 128 MiB across concurrent captures
...
and `DX402_MAX_INFLIGHT_BYTES` (default 128 MiB) bounds the memory all concurrent
